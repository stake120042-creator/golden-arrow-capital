          ...
          <div className="hidden md:flex relative">
            <div className="relative">
              <input 
                ...
                className="w-64 pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
              />
